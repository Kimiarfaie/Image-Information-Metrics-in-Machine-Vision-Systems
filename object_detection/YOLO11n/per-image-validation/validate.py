...
Usage:
    python validate.py --model yolo11n.pt --dataset "/home/.../Datasets/Full Dataset" --output "/home/.../YOLO11/per-image-validation/outputs" --classes 2 32 41 58
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="/Users/kimiaarfaie/Github/Image-Information-Metrics-in-Machine-Vision-Systems/object_detection/YOLO11n/per-image-validation/outputs",
