...
for network in networks:
    ...
    extracted_metrics_dir = f"/Users/kimiaarfaie/Github/Image-Information-Metrics-in-Machine-Vision-Systems/Metric_Analysis/Metrics/{iqm_source}/Extracted"
    output_dir = f"/home/colourlabgpu4/Kimia/Thesis/Metric_Analysis/{network}_plots/{iqm_source}/perimg_Plots/mAPvsIQM_Multidimensional_EV"
    ...
    print(f"Finished all plots for network: {network}\n")